...
NTSTATUS WINAPI ZwLoadDriver( const UNICODE_STRING *service_name )
{
    ...
    set_service_status( (void *)service_handle, SERVICE_START_PENDING, 0 );
    ...
    set_service_status( (void *)service_handle, SERVICE_RUNNING,
                        SERVICE_ACCEPT_STOP | SERVICE_ACCEPT_SHUTDOWN );
    CloseServiceHandle( service_handle );
    return STATUS_SUCCESS;

error:
    set_service_status( (void *)service_handle, SERVICE_STOPPED, 0 );
    CloseServiceHandle( service_handle );
    return status;
}
...
NTSTATUS WINAPI ZwUnloadDriver( const UNICODE_STRING *service_name )
{
    ...
    set_service_status( (void *)service_handle, SERVICE_STOP_PENDING, 0 );
